document.addEventListener('DOMContentLoaded', () => {
    ...
    const allFlashcardCategories = {
        ...
        "Bandura 1994": [
            ...
            { front: "Mestringsoplevelser", back: "Succes gennem egen indsats styrker selveffektivitet – nederlag uden succes svækker den." },
            { front: "Stedfortrædende oplevelser", back: "At se lignende personer lykkes øger troen på egen evne – rollemodeller er vigtige." },
            { front: "Social overtalelse", back: "Andres opmuntring kan styrke selveffektivitet – især hvis det ledsages af succesoplevelser." },
            { front: "Fysiologiske og emotionelle tilstande", back: "Hvordan man tolker sine følelser (f.eks. nervøsitet) påvirker selveffektivitet." },
            { front: "Kognitive processer", back: "Høj selveffektivitet fører til positive forestillinger og mål – lav fører til selvtvivl og undgåelse." },
            { front: "Motiverende processer", back: "Selveffektivitet påvirker årsagsforklaringer, forventninger og målsætning." },
            ...
            { front: "Outcome expectancies", back: "Vurdering af realistiske mål baseret på selveffektivitet." },
            ...
            { front: "Depression – lav social effektivitet", back: "Manglende tro på sociale evner fører til isolation og manglende støtte." },
            ...
            { front: "Sunde vaner og selveffektivitet", back: "Troen på egen evne til at opretholde vaner styrker sundhed." },
            { front: "Selektionsprocesser", back: "Selveffektivitet påvirker valg af miljø, relationer og livsretning." },
            { front: "Optimistisk selveffektivitet", back: "Let positiv bias øger kreativitet, vedholdenhed og innovation." },
            { front: "Kollektiv selveffektivitet", back: "Troen på gruppens evner styrker samarbejde og fælles mål." },
            { front: "Udvikling af handlefrihed", back: "Spædbørn lærer kausalitet og adfærdsindflydelse – grundlag for selveffektivitet." },
            { front: "Familiens rolle", back: "Fri leg og responsivitet fra forældre styrker personlig kontrol og selveffektivitet." },
            { front: "Søskende som spejl", back: "Børn spejler sig i familiemedlemmer – ældre søskende kan hæmme selveffektivitet." },
            { front: "Jævnaldrende", back: "Fællesskaber med ligesindede styrker selveffektivitet – prestige og popularitet spiller ind." },
            { front: "Skolens rolle", back: "Skolen validerer kompetencer – lærere og undervisningsform påvirker selveffektivitet." },
            { front: "Implicit læring i skolen", back: "Social sammenligning og niveauinddeling kan skade selveffektivitet." },
            { front: "Individuel undervisning", back: "Tilpasset undervisning styrker selveffektivitet ved at fokusere på egne fremskridt." },
            { front: "Teenageovergange", back: "Nye udfordringer kræver ny selveffektivitet – risikoadfærd kan både styrke og skade." },
            { front: "Voksenlivets krav", back: "Ægteskab, forældreskab og arbejde kræver selveffektivitet – lav fører til stress og tvivl." },
            { front: "Alderdommens selveffektivitet", back: "Troen på egne evner kan modvirke kognitiv nedgang og styrke livskvalitet." },
            { front: "Livsændringer og selveffektivitet", back: "Pension og tab kræver sociale færdigheder – lav social selveffektivitet øger sårbarhed." },
            { front: "Kulturens rolle", back: "Kulturelle holdninger til alderdom påvirker ældres selveffektivitet og produktivitet." },
